...
namespace jcvos
{
	...
	inline int jc_sprintf(TCHAR * buffer, size_t buf_size, LPCTSTR format, ... )
	{
		va_list argptr;
		va_start(argptr, format);
	...
	inline jcerrno jc_int2str(INT64 val, LPTSTR str, size_t buf_size, int base = 10);
	...
	inline jcerrno jc_uint2str(UINT64 val, LPTSTR str, size_t buf_size, int base = 10);
